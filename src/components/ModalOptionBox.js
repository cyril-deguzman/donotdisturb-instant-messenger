  ...
  return (
    <View>
      {props.optionName == "Change how they see you" ? (
        <ChangeHowTheySeeYouModal
          is2ndModalVisible={is2ndModalVisible}
          set2ndModalVisible={set2ndModalVisible}
          set1stModalVisible={props.set1stModalVisible}
      ...
      {props.optionName == "Delete this chat" ? (
        <DeleteAlertPopup
          ...
          set2ndModalVisible={set2ndModalVisible}
          set1stModalVisible={props.set1stModalVisible}
          deleteWhatText={"delete this chat"}
        />
      ) : null}
      ...
      >
        <View style={modalStyles.optionModalContainer}>
          <Image source={props.icon} style={modalStyles.optionModalIcon} />
          <Text style={modalStyles.optionModalText}>{props.optionName}</Text>
        </View>
      </TouchableHighlight>
    </View>
  );
