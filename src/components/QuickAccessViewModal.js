        ...
        >
          ...
          {props.isIndividualModal ? (
            <View>
              <ModalOptionBox
                icon={deleteIcon}
                optionName="Delete this chat"
                is1stModalVisible={isModalVisible}
                set1stModalVisible={setModalVisible}
              />
              <ModalOptionBox
                icon={muteNotificationsIcon}
                optionName="Mute notifications"
                is1stModalVisible={isModalVisible}
                set1stModalVisible={setModalVisible}
              />
              <ModalOptionBox
                icon={changeHowTheySeeYouIcon}
                optionName="Change how they see you"
                is1stModalVisible={isModalVisible}
                set1stModalVisible={setModalVisible}
            ...
            <View>
              ...
              <ModalOptionBox
                icon={addMembersIcon}
                optionName="Add members"
                is1stModalVisible={isModalVisible}
                set1stModalVisible={setModalVisible}
              />
              <ModalOptionBox
                icon={leaveIcon}
                optionName="Leave group"
                is1stModalVisible={isModalVisible}
                set1stModalVisible={setModalVisible}
              />
              <ModalOptionBox
