...
const ExcludeMembers = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.messageContainer}>
        ...
        {/* <ProfileCheckBox userStatus="idle" isChecked=true />
          <ProfileCheckBox userStatus="doNotDisturb" isChecked=true />
          <ProfileCheckBox userStatus="openToChat" isChecked=true /> */}
      </View>
    </View>
  );
};
